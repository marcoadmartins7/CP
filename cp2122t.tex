...
\begin{eqnarray*}
     ...
     \left\{
        \begin{array}{ll}
             \ensuremath{\alt{\Varid{q}\;\Varid{d}\;\underline{\mathrm{0}}}{\Varid{q}\;\Varid{d}\;\succ }\mathrel{=}\alt{f_1 \comp \Varid{id}}{f_2 \comp \conj{\Varid{q}\;\Varid{d}}{\conj{\Varid{r}\;\Varid{d}}{\Varid{c}\;\Varid{d}}}}}\\
             \ensuremath{\conj{\alt{\Varid{r}\;\Varid{d}\;\underline{\mathrm{0}}}{\Varid{r}\;\Varid{d}\;\succ }}{\alt{\Varid{c}\;\Varid{d}\;\underline{\mathrm{0}}}{\Varid{c}\;\Varid{d}\;\succ }}\mathrel{=}(\conj{\alt{g_1 \comp \Varid{id}}{g_2 \comp \conj{\Varid{q}\;\Varid{d}}{\conj{\Varid{r}\;\Varid{d}}{\Varid{c}\;\Varid{d}}}}}{\alt{h_1 \comp \Varid{id}}{h_2 \comp \conj{\Varid{q}\;\Varid{d}}{\conj{\Varid{r}\;\Varid{d}}{\Varid{c}\;\Varid{d}}}}})}\\
        \end{array}
     \right.
     \just\equiv{(1),(16)}
%
     ...
     \left\{
        \begin{array}{lll}
             \ensuremath{\alt{\Varid{q}\;\Varid{d}\;\underline{\mathrm{0}}}{\Varid{q}\;\Varid{d}\;\succ }\mathrel{=}\alt{f_1 }{f_2 \comp \conj{\Varid{q}\;\Varid{d}}{\conj{\Varid{r}\;\Varid{d}}{\Varid{c}\;\Varid{d}}}}}\\
             \ensuremath{\alt{\Varid{r}\;\Varid{d}\;\underline{\mathrm{0}}}{\Varid{r}\;\Varid{d}\;\succ }\mathrel{=}\alt{g_1 }{g_2 \comp \conj{\Varid{q}\;\Varid{d}}{\conj{\Varid{r}\;\Varid{d}}{\Varid{c}\;\Varid{d}}}}}\\
             \ensuremath{\alt{\Varid{c}\;\Varid{d}\;\underline{\mathrm{0}}}{\Varid{c}\;\Varid{d}\;\succ }\mathrel{=}\alt{h_1 }{h_2 \comp \conj{\Varid{q}\;\Varid{d}}{\conj{\Varid{r}\;\Varid{d}}{\Varid{c}\;\Varid{d}}}}}\\
        \end{array}
     \right.
     \just\equiv{(27)}
%
     ...
     \left\{
        \begin{array}{llllll}
             \ensuremath{\Varid{q}\;\Varid{d}\;\underline{\mathrm{0}}\mathrel{=}f_1 }\\
             \ensuremath{\Varid{q}\;\Varid{d}\;\succ \mathrel{=}f_2 \comp \conj{\Varid{q}\;\Varid{d}}{\conj{\Varid{r}\;\Varid{d}}{\Varid{c}\;\Varid{d}}}}\\
             \ensuremath{\Varid{r}\;\Varid{d}\;\underline{\mathrm{0}}\mathrel{=}g_1 }\\
             \ensuremath{\Varid{r}\;\Varid{d}\;\succ \mathrel{=}(g_2 \comp \conj{\Varid{q}\;\Varid{d}}{\conj{\Varid{r}\;\Varid{d}}{\Varid{c}\;\Varid{d}}})}\\
             \ensuremath{\Varid{c}\;\Varid{d}\;\underline{\mathrm{0}}\mathrel{=}h_1 }\\
             \ensuremath{\Varid{c}\;\Varid{d}\;\succ \mathrel{=}h_2 \comp \conj{\Varid{q}\;\Varid{d}}{\conj{\Varid{r}\;\Varid{d}}{\Varid{c}\;\Varid{d}}}}\\
        \end{array}
     \right.
     \just\equiv{(71),(72)}
%
     \left\{
        \begin{array}{llllll}
             \ensuremath{\Varid{q}\;\Varid{d}\;\underline{\mathrm{0}}\mathrel{=}f_1 }\\
             \ensuremath{\Varid{q}\;\Varid{d}\;(\Varid{x},(\Varid{y},\Varid{z}))\mathrel{=}\Varid{cond}\;(\Varid{z}\equiv \mathrm{0})\;(\succ \comp \p1)\;(\p1)}\\
             \ensuremath{\Varid{r}\;\Varid{d}\;\underline{\mathrm{0}}\mathrel{=}g_1 }\\
             \ensuremath{\Varid{r}\;\Varid{d}\;(\Varid{x},(\Varid{y},\Varid{z}))\mathrel{=}\Varid{cond}\;(\Varid{z}\equiv \mathrm{0})\;\underline{\mathrm{0}}\;(\succ \comp \p1\comp \p2)}\\
             \ensuremath{\Varid{c}\;\Varid{d}\;\underline{\mathrm{0}}\mathrel{=}h_1 }\\
             \ensuremath{\Varid{c}\;\Varid{d}\;(\Varid{x},(\Varid{y},\Varid{z}))\mathrel{=}\Varid{cond}\;(\Varid{z}\equiv \mathrm{0})\;\underline{\Varid{d}}\;(\Varid{pred}\comp \p2\comp \p2)}\\
        \end{array}
     \right.
     \just\equiv{(71)}
%
	...
	\begin{array}{llllll}
  	     \ensuremath{\Varid{q}\;\Varid{d}\;\underline{\mathrm{0}}\mathrel{=}f_1 }\\
	     \ensuremath{\Varid{q}\;\Varid{d}\mathrel{=}\Varid{cond}\;((\equiv \mathrm{0})\comp \p2\comp \p2)\;(\succ \comp \p1)\;(\p1)}\\
	     \ensuremath{\Varid{r}\;\Varid{d}\;\underline{\mathrm{0}}\mathrel{=}g_1 }\\
	     \ensuremath{\Varid{r}\;\Varid{d}\mathrel{=}\Varid{cond}\;((\equiv \mathrm{0})\comp \p2\comp \p2)\;\underline{\mathrm{0}}\;(\succ \comp \p1\comp \p2)}\\
      	     \ensuremath{\Varid{c}\;\Varid{d}\;\underline{\mathrm{0}}\mathrel{=}h_1 }\\
	     \ensuremath{\Varid{c}\;\Varid{d}\mathrel{=}\Varid{cond}\;((\equiv \mathrm{0})\comp \p2\comp \p2)\;\underline{\Varid{d}}\;(\Varid{pred}\comp \p2\comp \p2)}\\
        \end{array}
     \right.
     \just\equiv{def aux}
%
		 \ensuremath{\conj{\Varid{q}\;\Varid{d}}{\conj{\Varid{r}\;\Varid{d}}{\Varid{c}\;\Varid{d}}}} 
     \just\equiv{Pela Recursividade Mútua}
%

     \ensuremath{\cata{\conj{\alt{f_1 }{f_2 }}{\conj{\alt{g_1 }{g_2 }}{\alt{h_1 }{h_2 }}}}}
     \just\equiv{Substituição f1, g1, h1}
%

     \ensuremath{\cata{\conj{\alt{\underline{\mathrm{0}}}{f_2 }}{\conj{\alt{\underline{\mathrm{0}}}{g_2 }}{\alt{\underline{\Varid{d}}}{h_2 }}}}}
     \just\equiv{Transformação em for loop conforme visto na aula teórica}
%

     \ensuremath{\cata{\alt{(\underline{\mathrm{0}},(\underline{\mathrm{0}},\underline{\Varid{d}}))}{\conj{f_2 }{\conj{g_2 }{h_2 }}}}}

%
     \just\equiv{}
%

     \ensuremath{\for{\Varid{g}}\ {\Varid{d}}\;((\mathrm{0},(\mathrm{0},\Varid{d})))\;\mathbf{where}\;\Varid{g}\;\Varid{d}\;((\Varid{x},(\Varid{y},\Varid{z})))\mathrel{=}((f_2 ,(g_2 ,h_2 )))}
     \just\equiv{}
%

     \ensuremath{\for{\Varid{g}}\ {\Varid{d}}\;((\mathrm{0},(\mathrm{0},\Varid{d})))\;\mathbf{where}}
     \just\equiv{}
%
...
\\
\>[B]{}\Varid{alice}\;(\Conid{Fork}\;(\Varid{x},\Varid{y}))\mathrel{=}\Varid{umax}\;(\Varid{alice}\;(\Varid{x}),\Varid{alice}\;(\Varid{y})){}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{bob}\;(\Conid{Fork}\;(\Varid{x},\Varid{y}))\mathrel{=}\Varid{umin}\;(\Varid{bob}\;(\Varid{x}),\Varid{bob}\;(\Varid{y})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{both}\mathbin{::}\Conid{Ord}\;\Varid{d}\Rightarrow {\LTree}\;\Varid{d}\to (\Varid{d},\Varid{d}){}\<[E]%
\\
\>[B]{}\Varid{both}\mathrel{=}\conj{\Varid{alice}}{\Varid{bob}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\begin{eqnarray*}
\xymatrix@C=2cm{
    \ensuremath{{\LTree}\;\Varid{a}}
...
\\
     \ensuremath{\mathit B\times\mathit C}
&
     \ensuremath{\Conid{A}\mathbin{+}(\mathit B\times\mathit C)}^{2}
           \ar[l]^-{\ensuremath{\Varid{g}}}
}
\end{eqnarray*}
\begin{eqnarray*}
\start
    \left\{
        \begin{array}{lll}
            \ensuremath{\Varid{alice}\;(\Conid{Leaf}\;\Varid{x})\mathrel{=}\Varid{x}}\\
            \ensuremath{\Varid{alice}\;(\Conid{Fork}\;(\Varid{x},\Varid{y}))\mathrel{=}\Varid{umax}\;(\Varid{alice}\;(\Varid{x}),\Varid{alice}\;(\Varid{y}))}\\
            \ensuremath{\Varid{bob}\;(\Conid{Leaf}\;\Varid{x})\mathrel{=}\Varid{x}}\\
            \ensuremath{\Varid{bob}\;(\Conid{Fork}\;(\Varid{x},\Varid{y}))\mathrel{=}\Varid{umin}\;(\Varid{bob}\;(\Varid{x}),\Varid{bob}\;(\Varid{y}))}
        \end{array}
    \right.
    \just\equiv{ (20),(27),(71) }
%    
    \left\{
        \begin{array}{lll}
            \ensuremath{\Varid{alice}\comp \alt{\Conid{Fork}}{\Conid{Leaf}}\mathrel{=}\alt{\Varid{id}}{\Varid{umax}\;(\Varid{alice}\;(\Conid{X}),\Varid{alice}\;(\Conid{Y}))}}\\
            \ensuremath{\Varid{bob}\comp \alt{\Conid{Leaf}}{\Conid{Fork}}\mathrel{=}\alt{\Varid{id}}{\Varid{umin}\;(\Varid{bob}\;(\Conid{X}),\Varid{bob}\;(\Conid{Y}))}}
        \end{array}
    \right.
...
%
    \left\{
        \begin{array}{lll}
            \ensuremath{\Varid{alice}\comp \mathbf{in}\mathrel{=}\alt{\Varid{id}}{\Varid{id}}\comp (\Varid{id}\mathbin{+}\Varid{umax}\;(\Varid{alice}\;(\Conid{X}),\Varid{alice}\;(\Conid{Y})))}\\
            \ensuremath{\Varid{bob}\comp \mathbf{in}\mathrel{=}\alt{\Varid{id}}{\Varid{id}}\comp (\Varid{id}\mathbin{+}\Varid{umin}\;(\Varid{bob}\;(\Conid{X}),\Varid{bob}\;(\Conid{Y})))}
        \end{array}
    \right.
    \just\equiv{ }
%
    \left\{
        \begin{array}{lll}
            \ensuremath{\Varid{alice}\comp \mathbf{in}\mathrel{=}\alt{\Varid{id}}{\Varid{id}}\comp \Conid{F}\;\p1\comp \Conid{F}\;\conj{\Varid{alice}}{\Varid{bob}}}\\
            \ensuremath{\Varid{bob}\comp \mathbf{in}\mathrel{=}\alt{\Varid{id}}{\Varid{id}}\comp \Conid{F}\;\p2\comp \Conid{F}\;\conj{\Varid{alice}}{\Varid{bob}}}
        \end{array}
    \right.
    \just\equiv{ (52) }
%    
    \ensuremath{\conj{\Varid{alice}}{\Varid{bob}}\mathrel{=}\cata{\conj{\alt{\Varid{id}}{\Varid{id}}\comp \Conid{F}\;\p1}{\alt{\Varid{id}}{\Varid{id}}\comp \Conid{F}\;\p2}}}
...
\\[\blanklineskip]%
\>[B]{}\Varid{outLTree3}\;(\Conid{Tri}\;\Varid{a})\mathrel{=}i_1\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{outLTree3}\;(\Conid{Nodo}\;\Varid{t1}\;\Varid{t2}\;\Varid{t3})\mathrel{=}i_2\;((\Varid{t1},\Varid{t2}),\Varid{t3}){}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{cataLTree3}\;\Varid{g}\mathrel{=}\Varid{g}\comp (\Varid{recLTree3}\;(\Varid{cataLTree3}\;\Varid{g}))\comp \Varid{outLTree3}{}\<[E]%
\\[\blanklineskip]%
...
\begin{eqnarray*}
\xymatrix@C=2cm{
    \ensuremath{{\LTree}\;\Conid{Tri}}
           \ar[d]_-{\ensuremath{\Varid{folhasSierp}}}
           \ar@/^/[r]^-{\ensuremath{\mathsf{out}}}_-\cong
&
    \ensuremath{\Conid{Tri}\mathbin{+}(\Conid{Ltree3}\;\Conid{Tri}\times\mathsf{LTree3}\;\Conid{Tri})\times\mathsf{LTree3}\;\Conid{Tri}}
...
&
     \ensuremath{\Conid{Tri}\mathbin{+}(\Conid{Tri}}^*\ensuremath{\times\Conid{Tri}}^*\ensuremath{)\times\Conid{Tri}}^{*}
           \ar[l]^-{\ensuremath{g_1 }}
}
\end{eqnarray*}
...
\\
     \ensuremath{\Conid{Tri}\times\Conid{Int}}
           \ar[u]^-{\ensuremath{\Varid{geraSierp}}}
           \ar[r]^-{\ensuremath{g_2 }}
&
     \ensuremath{\Conid{Tri}\mathbin{+}((\Conid{Tri}\times\Conid{Int})\times(\Conid{Tri}\times\Conid{Int}))\times(\Conid{Tri}\times\Conid{Int})}
           \ar[u]_-{\ensuremath{\Varid{id}\mathbin{+}(\Varid{geraSierp}\times\Varid{geraSierp})\times\Varid{geraSierp}}}
}
\end{eqnarray*}
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}g_1 \mathrel{=}\alt{\Varid{singl}}{\uncurry{((\mathbin{+\!\!\!+})\comp (\mathsf{conc}))}}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{t1}\mathrel{=}(((\Varid{x},\Varid{y}),\Varid{s}\div \mathrm{2}),\Varid{n}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{t2}\mathrel{=}(((\Varid{x}\mathbin{+}\Varid{s}\div \mathrm{2},\Varid{y}),\Varid{s}\div \mathrm{2}),\Varid{n}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{t3}\mathrel{=}(((\Varid{x},\Varid{y}\mathbin{+}\Varid{s}\div \mathrm{2}),\Varid{s}\div \mathrm{2}),\Varid{n}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{figure}[htb]
    ...
    \end{center}
    \caption{Um triângulo de Sierpinski com profundidade \ensuremath{\mathrm{3}}.}
    \label{fig:sierp1}
\end{figure}
...
\xymatrix@C=2cm{
    \ensuremath{\Conid{A}}^{*}
           \ar[d]_-{\ensuremath{\Varid{propagate}}}
           \ar@/^/[r]^-{\ensuremath{\mathsf{out}}}_-\cong
&
    \ensuremath{\mathrm{1}\mathbin{+}\Conid{A}\mathbin{+}\Conid{A}}^{*}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times\Varid{propagate}}}
           \ar@/^/[l]^-{\ensuremath{\mathsf{in}}}
\\
     \ensuremath{\Conid{TB}}^{*}
&
     \ensuremath{\mathrm{1}\mathbin{+}\Conid{A}\times\Conid{TB}}^{*}
           \ar[l]^-{\ensuremath{\Varid{g}}}
}
\end{eqnarray*}
...
\xymatrix@C=2cm{
    \ensuremath{\N_0}^{*}
           \ar[d]_-{\ensuremath{\Varid{propagate3}}}
           \ar@/^/[r]^-{\ensuremath{\mathsf{out}}}_-\cong
&
    \ensuremath{\mathrm{1}\mathbin{+}\N_0\mathbin{+}\N_0}^{*}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times\Varid{propagate3}}}
           \ar@/^/[l]^-{\ensuremath{\mathsf{in}}}
\\
     \ensuremath{\Conid{T}\;\N_0}^{*}
&
     \ensuremath{\mathrm{1}\mathbin{+}\N_0\times\Conid{T}\;\N_0}^{*}
           \ar[l]^-{\ensuremath{\Varid{g}}}
}
\end{eqnarray*}
...
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{g}\;\Varid{f}\mathrel{=}\alt{\Varid{return}\comp \Varid{nil}}{g_2 \;\Varid{f}}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}g_2 \;\Varid{f}\;(\Varid{a},\Varid{b})\mathrel{=}{}\<[20]%
\>[20]{}\mathbf{do}\;\{\mskip1.5mu \Varid{a1}\leftarrow (\Varid{f}\;\Varid{a});\Varid{x}\leftarrow \Varid{b};\Varid{return}\;(\Varid{a1}\mathbin{:}\Varid{x})\mskip1.5mu\}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}g_2 \;\Varid{f}\;(\Varid{a},\Varid{b})\mathrel{=}\mathbf{do}\;\{\mskip1.5mu \Varid{a1}\leftarrow (\Varid{bitToBit3}\;\Varid{f}\;\Varid{a});\Varid{x}\leftarrow \Varid{b};\Varid{return}\;(\Varid{a1}\mathbin{:}\Varid{x})\mskip1.5mu\}{}\<[E]%
\\
\>[B]{}\Varid{bitToBit3}\;\Varid{f}\;\Varid{a}\mathrel{=}\mathbf{do}\;\{\mskip1.5mu \Varid{x}\leftarrow \Varid{f}\;(\Varid{a},\Varid{a},\Varid{a});\Varid{return}\;(v_3 \;\Varid{x})\mskip1.5mu\}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{bflip3}\;(\Varid{a},\Varid{b},\Varid{c})\mathrel{=}\mathbf{do}\;\{\mskip1.5mu \Varid{a1}\leftarrow \Varid{bflip}\;\Varid{a};\Varid{b1}\leftarrow \Varid{bflip}\;\Varid{b};\Varid{c1}\leftarrow \Varid{bflip}\;\Varid{c};\Varid{return}\;(\Varid{a1},\Varid{b1},\Varid{c1})\mskip1.5mu\}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
